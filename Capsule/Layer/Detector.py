...
from torchvision.models.detection.ssd import SSDHead, SSDScoringHead
...
class CapsuleWrappingDetector(nn.Module):
    '''
    Authors: dtvu1707@gmail.com
    Wrapping Detection model with Capsule head, 
    ...
    def __init__(self, model_configs: dict) -> None:
        ...
        super(CapsuleWrappingDetector, self).__init__()
        # Parse parameters
