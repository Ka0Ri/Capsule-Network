...
labels1 = np.repeat(labels1, repeats=2)
...
labels2 = np.repeat(labels2, repeats=2)
...
hf = h5py.File(path + "/data/smallNorb/smallNorb_test48.h5", 'w')
hf.create_dataset('data', data=examples2)
hf.create_dataset('labels', data=labels2)
hf.close()

hf = h5py.File(path + "/data/smallNorb/smallNorb_train48.h5", 'w')
hf.create_dataset('data', data=examples1)
hf.create_dataset('labels', data=labels1)
hf.close()